...
'-- NEW --
Public Const WCC_OUTPUT_WCX54 As Long = &H20
Public Const WCC_OUTPUT_PREPROCESSOR As Long = &H40
'--
...
Type TScriptCompilerError
  Number As Long
  String As String * MAX_PATH  ' FIXME VB TYPE name conflict
...
Declare Function wccFindError Lib "d:\wc5beta\wccdll.dll" _
            (ByVal sc As Long, _
             ByRef ei As TScriptCompilerError, _
...
Declare Function wccSetDefines Lib "d:\wc5beta\wccdll.dll" _
            (ByVal sc As Long, _
             ByVal szdefines As String) As Long
...
Public Function HexStr(i As Long, size As Integer) As String
