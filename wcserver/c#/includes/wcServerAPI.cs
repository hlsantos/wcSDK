...
namespace wcSDK
{
	...
	#region TSystemPageInstantMessage Changes ...
        ...
        {
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=28)] public string Name;
            public int ChannelId;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=80)] public string Text;
        }
        ...
        public struct TChatControlSwitch
        {
            ...
            public int NewId;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=80)] public string NewText;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Ansi)]
        public struct TChatAction
        {
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=28)] public string From;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=80)] public string Text;
            public int Target;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst=80)] public string TargetText;
        }
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst= 40)] public string Topic;
        }
