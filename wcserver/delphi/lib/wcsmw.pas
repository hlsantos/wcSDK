...
//
// Automatically generated from ..\include\wcsmw.h by cpp2pas.
//------------------------------------------------------------------------
{$O+,F+,I-,S-,R-}
unit wcsmw;
...
function MwSetDomainConfigVar(const szDomain: PChar; const szSection: PChar; const szKey: PChar; const szValue: PChar): BOOL; stdcall; external 'wcsmw.dll';
function MwSetConfigFileVar(const szFilename: PChar; const szSection: PChar; const szKey: PChar; const szValue: PChar): BOOL; stdcall; external 'wcsmw.dll';
function MwReloadDomainConfig: BOOL; stdcall; external 'wcsmw.dll';

//!----------------------------------------------------------------
//! Group: Server File Directory
//!----------------------------------------------------------------

function MwFindFirstFile(const fn: PChar; var fd: TWin32FindData): THandle; stdcall; external 'wcsmw.dll';
function MwFindNextFile(ff: THandle; var fd: TWin32FindData): BOOL; stdcall; external 'wcsmw.dll';
function MwFindClose(ff: THandle): BOOL; stdcall; external 'wcsmw.dll';
