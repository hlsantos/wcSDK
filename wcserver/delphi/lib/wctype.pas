...
//
// Automatically generated from ..\include\wctype.h by cpp2pas.
//------------------------------------------------------------------------
{$O+,F+,I-,S-,R-}
unit wctype;
...
const SIZE_ATTACH_FILE_NAME                 = 80;
const SIZE_PROGRAM_NAME                     = 64;
...
const OBJECTID_ALLOW_CC_GROUPS              = OBJECTCLASS_RIGHTS + 45;
const OBJECTID_ALLOW_IMAP_AUTH              = OBJECTCLASS_RIGHTS + 37;  // 46
...
const UserLastCallKey                       = 4;  // 452.1f
...
// const INVALID_WCHANDLE_VALUE                = WCHANDLE(INVALID_HANDLE_VALUE);
...
type TMakewild = record
  ...
  DateFormat : array[0..24-1] of char;
  TimeFormat : array[0..24-1] of char;
  DefaultDomain : array[0..SIZE_DOMAIN_NAME-1] of char;
  Reserved : array[0..12-1] of char;
...
type TComputerConfig = record
  ...
  Reserved : array[0..332-1] of BYTE;
  TelnetPort : DWORD;
  Pop3Port : DWORD;
end;
...
const pop3ResolveHost                       =  $0020;  //! resolve host name
...
const smtpResolveHost                       =  $0020;  //! resolve host name
const smtpDisableETRN                       =  $0040;  //! Disable ETRN command
const smtpAllowLocal                        =  $0080;  //! Allow (auth) Local Email
const smtpCheckHello                        =  $0100;  //! Enable Helo/Ehlo Check
const smtpEnableWCSAP                       =  $0200;  //! Enable WCSAP
const smtpEnableSFHook                      =  $0400;  //! Enable SMTPFILTER Hook
const smtpUsePort587                        =  $0800;  //! Submit Protocol
const smtpReadBadFilter=                    $1000;  //! Read only BadFilter (don't add)
const smtpReqSSLAuth                        =  $2000;  //! Require SSL for SMTP AUTH
...
const ftpCheckForDIZ                        =  $0008;  //! Check for DIZ in zip uploads
const ftpResolveHost                        =  $0020;  //! resolve host name
const ftpDisableIndex                       =  $0040;  //! Disable Index Files
...
const pwdAttemptsLockout                    =  $0010;  // TBD. Lockout for max pwds. FUTURE.
...
const httpEnableChunking                    =  $0008;  //! resolve host name
...
const maAllowReplyOnly                      =  $00000004;  // 451.6, User can reply only
const maAllowMacros                         =  $00000008;  // 452.1, Allow User macros
const maAllowMsgDelete                      =  $00000010;  // 452.2, Allow User delete
const maAllowDupes                          =  $00000020;  // 452.3, No Conference dupe checking
...
const faAllowFileComments                   =  $00000008;  // 453.2, Allow File Comments
...
const CALLTYPE_HTTPS                        =  $00000800;  // !!! HTTPS client
const CALLTYPE_IMAP                         =  $00001000;  // !!! IMAP client
...
const mfIMAPPost                            =  $10000000;  // Message was posted by wcIMAP
const mfMimeSaved                           =  $00000001;  // Mime Preserved
const mfNoDupeChecking                      =  $00000002;  // No dupe checking when adding msg (450.6)
const mfNoReplying                          =  $00000004;  // No Comments/Replies allowed (451.4)
...
type TMsgHeader = record
  ...
  AttachmentSFN : array[0..SIZE_SHORT_FILE_NAME-1] of char;
  ...
  ReadCount : DWORD;
  Attachment : array[0..SIZE_ATTACH_FILE_NAME-1] of char;
  ExtraCRC32 : DWORD;
  Reserved : array[0..7-1] of DWORD;
end;
...
const ffAllowFileComments                   =  $00000002;  // allows file comments

//!
//! File Comment
//!

type TFileComment = record
  area : DWORD;
  id : DWORD;
end;
...
type TConnectionInfo = record
  ...
  IpAddress : DWORD;
  ProgramName : array[0..SIZE_PROGRAM_NAME-1] of char;
  Domain : array[0..SIZE_DOMAIN_NAME-1] of char;
  Reserved1 : array[0..132-1] of BYTE;
  RefCount : DWORD;
  User : TUserInfo;
  HandlesOpen : DWORD;
  ChannelsOpen : DWORD;
  ...
  PeerAddress : DWORD;
  CallType : DWORD;
  Status : array[0..SIZE_NODEINFO_ACTIVITY-1] of char;
  Reserved : array[0..60-1] of BYTE;
end;
...
const saslTranslate                         =  $00000001;  //! Undot user name
const saslTranslateBoth                     =  $00000011;  //! Check Dot/Undot name
...
type TWildcatSASLContext = record
  ...
  szChallenge : array[0..256-1] of char;
  dwOptions : DWORD;
  dwState : DWORD;
  dwUserid : DWORD;
...
type TwcOpenFileInfo = record
  hFile : DWORD;
  dwSize : DWORD;
  ftWriteTime : TFileTime;
  dwAttributes : DWORD;
  dwSizeHigh : DWORD;
  reserved : array[0..232-1] of BYTE;
end;
...
type TWildcatServerGuid = record
  Time : TFileTime;
  Count : DWORD;
  szGuid : array[0..MAX_PATH-1] of char;
end;
...
type TWildcatGeoIP = record
  has_data : BOOL;
  ipaddr : array[0..16-1] of char;
  city : array[0..32-1] of char;
  continent : array[0..52-1] of char;
  country : array[0..52-1] of char;
  latitude : array[0..16-1] of char;
  longitude : array[0..16-1] of char;
  metro_code : array[0..16-1] of char;
  tzone : array[0..52-1] of char;
  postal : array[0..16-1] of char;
  country_code : array[0..8-1] of char;
  region_code : array[0..16-1] of char;
  region_name : array[0..52-1] of char;
end;
