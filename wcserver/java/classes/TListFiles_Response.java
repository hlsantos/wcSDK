...
public class TListFiles_Response extends TWildcatRequest {
  public int Area;
  public String Name;
  ...
  // Total size
  public static final int SIZE = TWildcatRequest.SIZE+4+16+76+4+72+32+4+8+8+4+4+4+2;

  // Constructors
  public TListFiles_Response()
  {
  }

  public TListFiles_Response(byte[] x)
  {
    fromByteArray(x);
  }
